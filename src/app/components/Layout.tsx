...
import { Menu, X, Linkedin, Github, Mail, Trophy, FileText, MapPin } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans flex flex-col">
      ...
      <footer className="relative bg-slate-900 text-slate-300 py-12 overflow-hidden">
        {/* Graphical "Optical Table" Grid Background */}
        <div 
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mb-2">Room 229</p>
            <p>Orlando, FL 32816</p>
          </div>
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">Connect</h3>
            <div className="flex space-x-4">
              <a href="https://www.linkedin.com/in/demibanerjee/" target="_blank" rel="noreferrer" className="bg-slate-800 p-2 rounded-full hover:bg-blue-600 transition-colors">
                <Linkedin size={20} />
              </a>
              <a href="https://github.com/demibanerjee" target="_blank" rel="noreferrer" className="bg-slate-800 p-2 rounded-full hover:bg-slate-700 transition-colors">
                <Github size={20} />
              </a>
              <a href="mailto:debasmita.banerjee@ucf.edu" className="bg-slate-800 p-2 rounded-full hover:bg-blue-500 transition-colors">
                <Mail size={20} />
              </a>
            </div>
          </div>
        ...
        <div className="relative mt-8 pt-8 border-t border-slate-800 text-center text-sm text-slate-500">
